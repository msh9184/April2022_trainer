...
parser.add_argument('--num_class',      type=int,   default=7205,   help='Number of speakers in the softmax layer, only for softmax-based losses')
...
parser.add_argument('--train_list',     type=str,   default="./list/train_vox1-vox2.txt", help='Train list')
    ...
    for it in range(it,args.max_epoch+1):
        ...
        if it % args.test_interval == 0:
            ...
            if args.gpu == 0:
                ...
                EERs += [result[1]]
                DCFs += [mindcf]
                print('\n',time.strftime("%Y-%m-%d %H:%M:%S"), "Epoch {:d}, ACC {:2.2f}, TLOSS {:f}, LR {:2.8f}, EER {:2.4f}, MinDCF {:2.5f}, bestEER {:2.4f}, bestMinDCF {:2.5f}".format(it, \
                                                                                                                                                                                       traineer, \
                                                                                                                                                                                       loss, \
                                                                                                                                                                                       lr, \
                                                                                                                                                                                       result[1], \
